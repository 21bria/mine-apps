...
def assay_roa_page(request):
    ...
    return render(request, 'admin-mgoqa/list-assay-roa.html',context)


class Assay_Roa(View):
...
def export_data_roa(request):
    ...
    queryset = AssayRoa.objects.all().values_list(*columns)
    ...
    response['Content-Disposition'] = 'attachment; filename="data_roa.xlsx"'
