            ...
            FROM 
                (
                    SELECT 
                        ...
                        ROUND(COALESCE(SUM(CASE WHEN nama_material ='Top Soil' THEN bcm ELSE 0 END), 0), 2) as TopSoil,
                        ROUND(COALESCE(SUM(CASE WHEN nama_material ='OB' THEN bcm ELSE 0 END), 0), 2) as OB,
                        ROUND(COALESCE(SUM(CASE WHEN nama_material ='LGLO' THEN bcm ELSE 0 END), 0), 2) as LGLO,
                        ROUND(COALESCE(SUM(CASE WHEN nama_material ='MGLO' THEN bcm ELSE 0 END), 0), 2) as MGLO,
                        ROUND(COALESCE(SUM(CASE WHEN nama_material ='HGLO' THEN bcm ELSE 0 END), 0), 2) as HGLO,
                        ROUND(COALESCE(SUM(CASE WHEN nama_material ='Waste' THEN bcm ELSE 0 END), 0), 2) as Waste,
                        ROUND(COALESCE(SUM(CASE WHEN nama_material ='MWS' THEN bcm ELSE 0 END), 0), 2) as MWS,
                        ROUND(COALESCE(SUM(CASE WHEN nama_material ='LGSO' THEN bcm ELSE 0 END), 0), 2) as LGSO,
                        ROUND(COALESCE(SUM(CASE WHEN nama_material ='MGSO' THEN bcm ELSE 0 END), 0), 2) as MGSO,
                        ROUND(COALESCE(SUM(CASE WHEN nama_material ='HGSO' THEN bcm ELSE 0 END), 0), 2) as HGSO,
                        ROUND(COALESCE(SUM(CASE WHEN nama_material ='Quarry' THEN bcm ELSE 0 END), 0), 2) as Quarry,
                        ROUND(COALESCE(SUM(CASE WHEN nama_material ='Ballast' THEN bcm ELSE 0 END), 0), 2) as Ballast,
                        ROUND(COALESCE(SUM(CASE WHEN nama_material ='Biomass' THEN bcm ELSE 0 END), 0), 2) as Biomass
