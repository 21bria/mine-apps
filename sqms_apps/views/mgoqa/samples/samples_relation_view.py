...
from ....models.samples_data_view_model import samplesNaPds
...
def samples_relation_page(request):
    ...
    return render(request, 'admin-mgoqa/production-samples/list-sample-relation.html',context)
...
def export_samples_relation(request):
    ...
    queryset = samplesNaPds.objects.all().values_list(*columns)
