...
from ....models.assay_over_release_model import listOverRoa
...
@login_required
def roa_over_page(request):
    # Cek permission
    permissions = get_dynamic_permissions(request.user)
    context = {
        'permissions': permissions,
    }
    return render(request, 'admin-mgoqa/list-not-ontime-roa.html',context)


class roaOverData(View):
